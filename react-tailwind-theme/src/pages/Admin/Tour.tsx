		...
		<div className="space-y-6">
			...
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-slate-600 mt-1">Manage all tour packages and destinations</p>
				</div>
				...
				<div className="overflow-x-auto">
					<table className="w-full">
						<thead className="bg-slate-50 border-b border-slate-200">
							<tr>
								<th className="px-6 py-4 text-left text-sm font-semibold text-slate-900">Tour Name</th>
								...
								<tr key={i} className="hover:bg-slate-50 transition-colors">
									<td className="px-6 py-4">
										<div className="flex items-center gap-3">
											...
											<div>
												<p className="font-semibold text-slate-900">Ha Long Bay Tour {i}</p>
												<p className="text-sm text-slate-500">3 days 2 nights</p>
											</div>
										</div>
									</td>
									<td className="px-6 py-4 text-slate-700">Quang Ninh, Vietnam</td>
									<td className="px-6 py-4 text-slate-900 font-semibold">${Math.floor(Math.random() * 500) + 200}</td>
									<td className="px-6 py-4">
										<span className={`px-3 py-1 rounded-full text-xs font-semibold ${i % 2 === 0
