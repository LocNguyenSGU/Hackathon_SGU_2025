...
import { MapPin, Mail, Lock, Eye, EyeOff, User, Phone, Loader2, AlertCircle, CheckCircle2 } from 'lucide-react'
		...
		<div className="min-h-screen bg-gradient-to-br from-emerald-50 via-blue-50 to-purple-50 flex items-center justify-center p-4">
			<div className="w-full max-w-2xl">
				...
				<div className="text-center mb-8">
					...
					<p className="text-slate-600">Join AI Tour Planner and start your journey</p>
				</div>
					...
					<form onSubmit={handleSubmit} className="space-y-6">
						...
						{success && (
							<div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4 flex items-start gap-3">
								...
								<div>
									<p className="text-sm text-emerald-800 font-medium">Registration Successful!</p>
									<p className="text-sm text-emerald-600">Redirecting to login page...</p>
								</div>
							</div>
						)}
						...
						<div className="flex items-start gap-2">
							<input
								...
								id="terms"
								required
								className="w-4 h-4 mt-1 text-emerald-500 border-slate-300 rounded focus:ring-emerald-500"
							/>
